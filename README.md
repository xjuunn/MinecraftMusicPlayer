...
- 支持自动播放下一首`r`n- 播放时会按多个候选音源依次尝试，前一个失败会自动切换到下一个
- 支持玩家投票切歌
...
- Java `21`
- 一个可用的 [NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) 实例，默认地址为 `https://odlimemusicapi.vercel.app/`
